...
//             <div className="w-[500px] h-[500px] rounded-full bg-red-100 absolute -top-32 -left-32"></div>
//             <div className="w-[400px] h-[400px] rounded-full bg-red-200 absolute -top-16 -right-40"></div>
//             <div className="w-[300px] h-[300px] rounded-full bg-red-300 absolute top-20 left-20"></div>
//             <div className="w-[200px] h-[200px] rounded-full bg-red-400 absolute top-32 right-32"></div>
//           </div>

//           {/* Content */}
//           <h1 className="text-4xl font-bold text-gray-900 relative z-10">
//             Maximise your investments, systematically.
//           </h1>
//           <p className="mt-4 text-xl text-gray-600 relative z-10">
//             Use our SIP Calculators to know how
//           </p>
//         </div>
//       </div>
...
//             Why Systematic Investment Plans (SIP)?
//           </h2>
//           <p className="text-lg text-gray-600 mb-8">
//             A Systematic Investment Plan (SIP) is a method of investing in
//             mutual funds. It allows you to invest a fixed amount periodically,
//             helping you achieve your financial goals systematically.
//           </p>
//           <ul className="list-disc list-inside text-gray-700 space-y-4">
//             <li>Start small with regular investments.</li>
//             <li>Benefit from the power of compounding.</li>
//             <li>Reduce market risk through rupee cost averaging.</li>
//           </ul>
//         </div>
//       </div>
...
//             Use our SIP Calculator to plan your investments and achieve your
